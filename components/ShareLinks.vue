  ...
  <div class="pt-5">
    <v-tooltip bottom>
      <template #activator="{ on }">
        <a
          v-on="on"
          @click="copyLink(`https://b5.wisdoerglobal.com/${id}`)"
        >
    ...
    <v-tooltip bottom>
      <template #activator="{ on }">
        <a
          :href="'https://www.facebook.com/sharer/sharer.php?u=https://b5.wisdoerglobal.com/' + id"
          target="_blank"
          rel="noopener"
    ...
    <v-tooltip bottom>
      <template #activator="{ on }">
        <a
          :href="'https://twitter.com/intent/tweet?text=See my personality traits!&url=https://b5.wisdoerglobal.com/' + id"
          target="_blank"
          rel="noopener"
