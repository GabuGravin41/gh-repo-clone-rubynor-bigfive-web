...
export const formatId = id => /^((http|https):\/\/)/.test(id) ? id.replace((process.env.NODE_ENV === 'development' ? 'http://localhost:8080' : 'https://b5.wisdoerglobal.com') + '/result/', '').replace(' ', '').toLowerCase() : id ? id.replace(' ', '') : id
