export default {
  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'og:url', name: 'og:url', content: 'https://b5.wisdoerglobal.com' },
      { hid: 'og:image', name: 'og:image', content: 'https://b5.wisdoerglobal.com/icon.png' },
      ...
      { hid: 'twitter:image', name: 'twitter:image', content: 'https://b5.wisdoerglobal.com/icon.png' },
  ...
  modules: [
    ...
    [
      'nuxt-i18n',
      {
        ...
        seo: true,
        baseUrl: 'https://b5.wisdoerglobal.com',
        defaultLocale: 'en',
  ...
  */
  ...
  sitemap: {
    hostname: 'https://b5.wisdoerglobal.com'
  },
  webfontloader: {
    google: {
  ...
  env: {
    API_URL: 'https://b5.wisdoerglobal.com/api/' // TODO: Fix for dev environment
  },
  build: {
    extractCSS: true,
    extend (config, ctx) {
