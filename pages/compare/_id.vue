...
export default {
  ...
  head: () => ({
    ...
    meta: [
      ...
      { name: 'og:url', content: 'https://b5.wisdoerglobal.com' },
      { name: 'og:image', content: 'https://b5.wisdoerglobal.com/icon.png' },
      // Twitter Card
      ...
      { name: 'twitter:image', content: 'https://b5.wisdoerglobal.com/icon.png' },
